...
int main(){
    ...
    */
   double Il =  0.171324*exp((-0.5)*(pow(0.5+(0.932470/2), 2))) + 
                0.360761*exp((-0.5)*(pow(0.5+(0.661209/2), 2))) +
                0.467913*exp((-0.5)*(pow(0.5+(0.238619/2), 2))) +
                0.171324*exp((-0.5)*(pow(0.5+(-0.932470/2), 2))) +
                0.360761*exp((-0.5)*(pow(0.5+(-0.661209/2), 2))) +
                0.467913*exp((-0.5)*(pow(0.5+(-0.238619/2), 2)));
